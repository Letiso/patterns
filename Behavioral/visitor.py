...
class FirstComponent(Component):
    ...
    def special_first_component_logic(self):
...
class SecondComponent(Component):
    ...
    def exclusive_second_component_logic(self):
        print(f"{self.__class__.__name__}: Doing special logic...")
...
class Visitor:
    @abstractmethod
    def visit_first_component(self, component: FirstComponent): pass

    @abstractmethod
    def visit_second_component(self, component: SecondComponent): pass


class FirstVisitor(Visitor):
    def visit_first_component(self, component: FirstComponent):
        print(f"{component.special_first_component_logic()} + FirstVisitor additional logic")

    def visit_second_component(self, component: SecondComponent):
